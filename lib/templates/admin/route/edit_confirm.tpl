...
{block name=content}
	<main class="u-mb-32">
		<section>
			...
			<form action="/expense/admin/route/edit/{$form_data.route_id}/" method="POST">
				...
				<dl class="form-block__group">
					<div class="form-block__field">
						...
						<dd class="form-block__input-wrap">{$form_data.route}</dd>
					</div>
				</dl>
			...
			{* 戻る *}
			<form action="/expense/admin/route/edit/{$form_data.route_id}/" method="POST" class="js-entry-form" style="display: none;">
